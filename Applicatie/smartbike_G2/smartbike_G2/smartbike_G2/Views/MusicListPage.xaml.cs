...
namespace smartbike_G2.Views
{
    ...
    public partial class MusicListPage : ContentPage
    {
        ...
        private List<PlaylistData> Music = new List<PlaylistData>();
        ...
        private async void GetVideos(bool IsSet)
        {
            ...
            lvwMusic.ItemsSource = Playlist.GetRange(1, Playlist.Count - 1);
        }
        ...
        private async void GetPlaylists()
        {
            ...
            foreach (var item in Channel)
            {
                ...
                // If yes add to Music list and add title minus the "Muziek - " part to the picker
                if (item.Title.ToLower().Contains("muziek"))
                {
                    Music.Add(item);
        ...
        private void LvwMusic_ItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            MyVideo = (lvwMusic.SelectedItem as VideoData).VideoId;
            MyVideoName = (lvwMusic.SelectedItem as VideoData).Title;
            GetVideos(true);
        ...
        // End screen button
        private void EndScreenTest_Clicked(object sender, EventArgs e)
        {
            SummonMenu();
        }
        ...
        {
            SmartbikeRepository.PlaylistID = Music[pickerGenre.SelectedIndex].PlaylistId;
            GetVideos(false);
        }
        ...
        {
            base.OnAppearing();
            SmartbikeRepository.PlaylistID = SetupData.DefaultMusic;
            GetVideos(false);
            PageOpen = true;
            TurnedOn = false;
            KeepRunning = true;
